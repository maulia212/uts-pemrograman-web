...
<div class="banner_section layout_padding">
         <div class="container">
            <div id="costum_slider" class="carousel slide" data-ride="carousel">
               ...
               <i class=""><img src="<?= base_url('assets/images/left-arrow.png')?>"></i>
               </a>
               <a class="carousel-control-next" href="#costum_slider" role="button" data-slide="next">
               <i class=""><img src="<?= base_url('assets/images/right-arrow.png')?>"></i>
               </a>
            </div>
         </div>
      </div>
            ...
            <div class="services_section2 layout_padding">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="icon_1"><img src="<?= base_url('assets/images/icon-1.png')?>"></div>
                     ...
                     <div class="read_bt_main">
                        <div class="read_bt"><a href="<?= base_url('services')?>">Read More</a></div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="icon_1"><img src="<?= base_url('assets/images/icon-2.png')?>"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="icon_1"><img src="<?= base_url('assets/images/icon-3.png')?>"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="icon_1"><img src="<?= base_url('assets/images/icon-4.png')?>"></div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="read_bt1"><a href="<?= base_url('about')?>">Read More</a></div>
               </div>
               <div class="col-md-6">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="container_main">
                        <img src="<?= base_url('assets/images/img-2.png')?>" alt="Avatar" class="image">
                        <div class="overlay">
                  ...
                  <div class="col-md-6">
                     <div class="container_main">
                        <img src="<?= base_url('assets/images/img-3.png')?>" alt="Avatar" class="image">
                        <div class="overlay">
                           <a href="#" class="icon" title="User Profile">
                           <i class="fa fa-search"></i>
                           </a>
                           ...
                           <div class="row">
                              <div class="col-sm-4">
                                 <div class="container_main1">
                                    <img src="<?= base_url('assets/images/img-4.png')?>" alt="Avatar" class="image" style="width:100%">
                              ...
                              <div class="col-sm-4">
                                 <div class="container_main1">
                                    <img src="<?= base_url('assets/images/img-5.png')?>" alt="Avatar" class="image" style="width:100%">
                                    <h1 class="modern_text">Modern home designe</h1>
                                    <div class="middle">
                                       <div class="text">VIEW MORE</div>
                                    </div>
                              ...
                              <div class="col-sm-4">
                                 <div class="container_main1">
                                    <img src="<?= base_url('assets/images/img-6.png')?>" alt="Avatar" class="image" style="width:100%">
                                    <h1 class="modern_text">Modern home designe</h1>
                                    <div class="middle">
                                       <div class="text">VIEW MORE</div>
                                    </div>
                  ...
                  <div class="carousel-item active">
                     ...
                     <div class="clients_section2 layout_padding">
                        <div class="client_1">
                           <div class="row">
                              <div class="col-sm-3">
                                 <div class="image_7"><img src="<?= base_url('assets/images/img-7.png')?>"></div>
                                 <div class="quote_icon"><img src="<?= base_url('assets/images/quote-icon.png')?>"></div>
                              </div>
                              <div class="col-sm-9">
                        ...
                        <div class="client_2">
                           <div class="row">
                              <div class="col-sm-3">
                                 <div class="image_7"><img src="<?= base_url('assets/images/img-8.png')?>"></div>
                                 <div class="quote_icon"><img src="<?= base_url('assets/images/quote-icon.png')?>"></div>
                              </div>
                              <div class="col-sm-9">
                                 <h1 class="loksans_text">loksans</h1>
            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="mail_sectin">
                     ...
                     <div class="send_bt"><a href="<?= base_url('contact')?>">SEND</a></div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="map_main">
